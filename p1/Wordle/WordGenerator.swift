...
class WordGenerator {
  ...
  static let possibleWords = ["APPLE", "BEACH", "BREAD", "CHICK", "DANCE", "EARTH", "CHAIR", "FIELD", "HELLO", "GRAPE", "JELLY", "HOUSE", "LIGHT", "MONEY", "NIGHT", "OCEAN", "PIZZA", "QUICK", "OXIDE", "PEACH", "QUICK", "ROBOT", "SCALE", "WATER", "TIGER", "UNITE", "VOICE"]
